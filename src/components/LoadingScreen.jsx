      ...
      <div className="text-center">
        <div className="relative mb-8">
          <div className="relative w-32 h-32 mx-auto">
            <div className="absolute inset-0 border-4 border-green-200 rounded-full animate-spin" 
                 style={{ 
        ...
        <div className="space-y-3">
          ...
          <div className="w-64 h-2 bg-gray-200 rounded-full overflow-hidden mx-auto">
            <div className="h-full bg-gradient-to-r from-green-500 via-blue-500 to-green-500 rounded-full animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-green-400 rounded-full opacity-40 animate-ping"
              style={{
                left: `${(i + 1) * 15}%`,
